...
//forEach
const numberFive=[5,10,15,20,25,30,35,40];
numberFive.forEach( (numberFive)=> console.log(numberFive%3===0?numberFive:('')))

//filter
const word=['ship','race','ark','girl', 'machine']
const newWord=word.filter(word=>word.length>3)
console.log(newWord)
const myAge=[20,25,8,21,14,6,70]
const ageAccepted=myAge.filter(myAge=>myAge>16)
console.log(ageAccepted)


const newToDo=toDo.filter((toDo)=> toDo.task==='cooking')
console.log (newToDo)
